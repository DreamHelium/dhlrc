...
int dhlrc_init_translation_from_content (const char *content,
                                         const char *large_version);
...
char *dhlrc_get_version_json_string (const char *version, SetFunc set_func,
                                     void *klass, int min, int max);
char *dhlrc_get_translation_file (const char *filename,
